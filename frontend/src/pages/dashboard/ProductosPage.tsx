...
export default function ProductosPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <SectionCard title="Distribución por categorías">
        <p className="text-sm text-slate-500 mb-4">
          Agrupación por clase de renglón en el POS: bebidas, alimentos y otros artículos. Pulsa una fila para filtrar el listado
      ...
      <SectionCard title="Productos vendidos (listado completo)">
        <p className="text-sm text-slate-500 mb-4">
          Se incluyen todos los productos del periodo seleccionado para las sucursales filtradas.
        </p>
        <div className="overflow-x-auto rounded-lg border border-slate-200">
          <table className="w-full text-sm">
            <thead>
